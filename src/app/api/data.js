import avatar_dan from "../media/images/profile_dan.jpg"
import avatar_matheus from "../media/images/profile_matheus.jpg"
import avatar_tyler from "../media/images/profile_tyler.jpg"

let users = {
  matheusicaro: {
    id: "matheusicaro",
    name: "Matheus Icaro",
    avatarURL: avatar_matheus,
...
let tweets = {
  ...
  "5c9qojr2d1738zlx09afby": {
    ...
    likes: ['matheusicaro', 'dan_abramov'],
  ...
  "czpa59mg577x1oo45cup0d": {
    ...
    author: "dan_abramov",
    timestamp: 1515043995650,
    likes: ['tylermcginnis', 'matheusicaro'],
  ...
  "sfljgka8pfddbcer8nuxv": {
    ...
    likes: ['matheusicaro', 'tylermcginnis'],
    replyingTo: "hbsc73kzqi75rg7v1e0i6a",
    replies: [],
  },
